  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-surface-900">
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-0 right-0 h-96 w-96 rounded-full bg-brand-700/15 blur-3xl" />
        <div className="absolute bottom-0 left-0 h-64 w-64 rounded-full bg-violet-700/10 blur-3xl" />
      </div>
      ...
      <div className="relative w-full max-w-md animate-slide-up">
        <div className="glass-card p-8 sm:p-10">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-white">Join LocalLoop</h1>
            <p className="text-slate-400 text-sm mt-1">Create your free account today</p>
          </div>

          {apiErr && (
            <div className="flex items-start gap-2 bg-red-500/10 border border-red-500/30 rounded-xl p-3 text-sm text-red-300 mb-4">
          ...
          <button
            ...
            className="btn-secondary w-full justify-center mb-5"
          >
            {GOOGLE_ICON}
            {googleL ? 'Signing up…' : 'Continue with Google'}
          </button>
